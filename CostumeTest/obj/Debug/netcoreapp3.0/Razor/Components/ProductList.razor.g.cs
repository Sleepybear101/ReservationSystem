...
#nullable restore
#line 14 "C:\Users\wurud\Documents\GitHub\ReservationSystem\CostumeTest\Components\ProductList.razor"
                 for (i = 1; i <= 3; i++)
                {
...
#nullable disable
            ...
            __builder.AddAttribute(14, "style", " border:none ;background-color:dimgray ;width: 47px;height: 57px; margin-left: 10px;margin-right: 33px; ");
...
#nullable restore
#line 19 "C:\Users\wurud\Documents\GitHub\ReservationSystem\CostumeTest\Components\ProductList.razor"
                    TableNumber++;
                }
...
#nullable disable
            ...
            __builder.AddMarkupContent(24, @"<div style=""margin-top: 7%;"">
                <button style="" border:none ;background-color:dimgray ; width: 47px; height: 87px; margin-left: 27px; margin-right: 40px; margin-top: 15px;"" data-toggle=""modal"" data-target=""#productModal"" class=""btn btn-primary"">
                    4
                </button>
            </div>

            ");
            __builder.AddMarkupContent(25, @"<div style=""padding-left: 50%;height: 7%; margin-top: -3%;"">
            ...
            ");
            __builder.AddMarkupContent(26, @"<div style=""width: 27%; margin-left: 1%;margin-bottom: 24%;  margin-top: 3%;"">
            ...
            ");
            __builder.AddMarkupContent(27, @"<div style=""  width: 19%; margin-left: 1%;   "">
