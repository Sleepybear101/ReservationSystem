#pragma checksum "C:\Users\royhe\OneDrive\Documenten\GitHub\ReservationSystem\ReservationAdmin\Component\SelectReservations.razor" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "b752826275037f986b68931a5218daa7c4f864a7"
// <auto-generated/>
...
#line 84 "C:\Users\royhe\OneDrive\Documenten\GitHub\ReservationSystem\ReservationAdmin\Component\SelectReservations.razor"
                                              (e => DeleteReservation(dr[7].ToString(),dr[6].ToString()))
...
#nullable disable
            ...
            __builder.AddMarkupContent(118, "<i class=\"fas fa-window-\"></i>&#10060;");
            __builder.CloseElement();
...
#line 87 "C:\Users\royhe\OneDrive\Documenten\GitHub\ReservationSystem\ReservationAdmin\Component\SelectReservations.razor"
                                                  (e => UpdateNoShow(dr[6].ToString()))

#line default
#line hidden
#nullable disable
            ));
            __builder.AddAttribute(123, "class", "NoshowButton");
            __builder.AddAttribute(124, "style", "float: left;background-color: #F0F1F7;border: none;border-radius: 10%; width: 36px;height: 28px;");
            __builder.AddMarkupContent(125, "<i class=\"fas fa-eye-slash\"></i>");
            __builder.CloseElement();
...
#line 98 "C:\Users\royhe\OneDrive\Documenten\GitHub\ReservationSystem\ReservationAdmin\Component\SelectReservations.razor"
    ...
    void DeleteReservation(string ReservationID, string GuestID)
    {
        con.SqlQuery("DELETE FROM reservation WHERE reservation.id_Reservation = @ReservationID AND reservation.Guest = @GuestID ");
        con.Cmd.Parameters.AddWithValue("@ReservationID", ReservationID);
        con.Cmd.Parameters.AddWithValue("@GuestID", GuestID);
        con.QueryEx();
    }
    //update de geselecteerde klant die niet is komen opdagen
    void UpdateNoShow(string GuestID)
    {
