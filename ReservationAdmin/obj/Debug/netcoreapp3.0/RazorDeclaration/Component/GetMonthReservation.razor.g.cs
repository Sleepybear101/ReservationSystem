#pragma checksum "C:\Users\wurud\Documents\GitHub\ReservationSystem\ReservationAdmin\Component\GetMonthReservation.razor" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "d788620155ab0dac9eb28ada9754de7d0994a0af"
// <auto-generated/>
...
#line 34 "C:\Users\wurud\Documents\GitHub\ReservationSystem\ReservationAdmin\Component\GetMonthReservation.razor"
    ...
    public void SetLastMonth()
    {
        ...
        for (int i = 1; i < 31; i++)
        {
            con.SqlQuery("SELECT COUNT(*) as Total1 FROM `reservation` WHERE `Date` = '"+year+"-" + Month + "-"+i+"'");
            con.QueryEx();
